...
APP_VERSION = "V42 · Estimativas validadas"
...
<title>V42 - Diário Alimentar · Estimativas validadas</title>
<style>
...
html{
  ...
  background-image:
    ...
    url("/a_wide_high_resolution_panoramic_landscape_photo.png?v=42")!important;
